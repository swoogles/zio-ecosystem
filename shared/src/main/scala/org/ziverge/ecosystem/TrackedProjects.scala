      ...
      coreProjects ++
        List(
          ...
          Project(
            ...
            "caliban",
            Some("https://github.com/ghostdogpr/caliban")
          ),
          ...
          Project(
            "io.github.neurodyne",
            "zio-arrow",
            Some("https://github.com/zio-mesh/zio-arrow")
          ),
          ...
          Project(
            ...
            "zio-grpc-core",
            Some("https://github.com/scalapb/zio-grpc")
          ),
          Project(
            "com.thesamet.scalapb.zio-grpc",
            "zio-grpc-codegen",
...
//      Project("io.github.vigoo", "clipp-cats-effect", Some("https://github.com/vigoo/clipp")),
  ...
  lazy val proxProjects =
    ProjectGroup(
      "Prox Projects",
      List(Project("io.github.vigoo", "prox-zstream-2", Some("https://github.com/vigoo/prox")))
    )
